  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filter data where "WhatsApp" is true
        const filteredWhatsAppData = data.filter((record: FormRecord) => record.WhatsApp === true);
        
        setFormData(filteredWhatsAppData); // Set filtered data to state
        setFilteredData(filteredWhatsAppData);
        setLoading(false);
      } catch (error) {
